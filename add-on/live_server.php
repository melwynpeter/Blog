        ...
        <div id="html">
            <p id="htmlText">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" placeholder="Paste Your HTML code" id="htmlTextContent" name="content" style="height: 300px"></textarea>
                </div>
            </p>
        </div>
    </div>
    <script src="js/live_server.js"></script>
