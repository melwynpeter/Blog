...
console.log("The blog id is: ", blog_id.value);
...
function likeHandler(){
    ...
    // opening the object
    xhr.open('POST', 'partials\/_handle_likesanddislikes.php', true);
    ...
    let data = "likeNumber=" + likeNumber.value + "&blogId=" + blog_id.value;
    xhr.send(data);
}
...
function dislikeHandler(){
    ...
    // send
    let data = "likeNumber=" + dislikeNumber.value + "&blogId=" + blog_id.value;
    xhr.send(data);
}
